...
from ppuda.ghn.nn import GHN, ghn_parallel, MLP_GHN
from ppuda.vision.loader import image_loader
from ppuda.deepnets1m.loader import DeepNets1M, MLPNets1M
from ppuda.utils import capacity, Trainer, MLPTrainer
from ppuda.deepnets1m.net import Network, MlpNetwork
import numpy as np
...
def main():
    ...
    bc_data = np.load('data/hc.npz')
    states = bc_data['states']
    ...
    train_queue, val_queue, num_classes = my_dataloader, my_dataloader, 6
    ...
    graphs_queue = MLPNets1M.loader(args.meta_batch_size,
                                     split=args.split,
                                     nets_dir=args.data_dir,
                                     virtual_edges=args.virtual_edges,
                                     num_nets=args.num_nets,
